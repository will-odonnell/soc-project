...
public:
	...
	//_FREAL	Decode(CFDistance vecNewDistance[],
...
/*
  ...
  */
  // Decoder HAL Interface
  int  	TLM_ctr;
  int	TLM_sts;
  CParameter::ECodScheme TLM_eNewCodingScheme;
  CParameter::EChanType  TLM_eNewChannelType;
  int	TLM_iN1;
  int	TLM_iN2;
  int	TLM_iNewNumOutBitsPartA;
  int	TLM_iNewNumOutBitsPartB;
  int	TLM_iPunctPatPartA;
  int 	TLM_iPunctPatPartB;
  int	TLM_iLevel;
  int	TLM_index;
  CFDistance	TLM_dataIn[128];
  _DECISION	TLM_dataOut[128];
