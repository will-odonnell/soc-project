	...
	case CParameter::CS_2_SM:
			...
			for (i = 0, k = 0; i < iInputBlockSize; i++, k += 2)
			{
				if (bIteration == TRUE)
				{
					...
					vecMetric[k].rTow0 =
						...
						fTableQAM16[BI_00 /* [0  0] */][0],
						fTableQAM16[BI_01 /* [0  1] */][0],
						(*pcInSymb)[i].rChan, vecSubsetDef2[k]);

					vecMetric[k].rTow1 =
						Minimum2((*pcInSymb)[i].cSig.real(),
						fTableQAM16[BI_10 /* [1  0] */][0],
						fTableQAM16[BI_11 /* [1  1] */][0],
						(*pcInSymb)[i].rChan, vecSubsetDef2[k]);
#else
					...
					vecMetric[k].rTow0 =
						...
						fTableQAM16[iTabInd0][0], (*pcInSymb)[i].rChan);

					/* Distance to "1" */
					vecMetric[k].rTow1 =
						Minimum1((*pcInSymb)[i].cSig.real(),
						fTableQAM16[iTabInd0 | (1 << 1)][0],
						(*pcInSymb)[i].rChan);
#endif
					...
					vecMetric[k + 1].rTow0 = Minimum2((*pcInSymb)[i].cSig.imag(),
						fTableQAM16[BI_00 /* [0  0] */][1],
						fTableQAM16[BI_01 /* [0  1] */][1],
						(*pcInSymb)[i].rChan, vecSubsetDef2[k + 1]);

					vecMetric[k + 1].rTow1 = Minimum2((*pcInSymb)[i].cSig.imag(),
						fTableQAM16[BI_10 /* [1  0] */][1],
						fTableQAM16[BI_11 /* [1  1] */][1],
						(*pcInSymb)[i].rChan, vecSubsetDef2[k + 1]);
#else
					/* Lowest bit defined by "vecSubsetDef2" */
					...
					vecMetric[k + 1].rTow0 =
						...
						fTableQAM16[iTabInd0][1], (*pcInSymb)[i].rChan);

					/* Distance to "1" */
					vecMetric[k + 1].rTow1 =
						Minimum1((*pcInSymb)[i].cSig.imag(),
						fTableQAM16[iTabInd0 | (1 << 1)][1],
						(*pcInSymb)[i].rChan);
#endif
				}
				else
		...
		case 1:
			for (i = 0, k = 0; i < iInputBlockSize; i++, k += 2)
			{
				...
				/* Distance to "1" */
				vecMetric[k].rTow1 = Minimum1((*pcInSymb)[i].cSig.real(),
					fTableQAM16[iTabInd0 | 1][0], (*pcInSymb)[i].rChan);
#endif
				...
				/* Distance to "1" */
				vecMetric[k + 1].rTow1 = Minimum1((*pcInSymb)[i].cSig.imag(),
					fTableQAM16[iTabInd0 | 1][1], (*pcInSymb)[i].rChan);
#endif
			}
			...
			for (i = 0, k = 0; i < iInputBlockSize; i++, k += 2)
			{
				if (bIteration == TRUE)
				{
					...
					vecMetric[k].rTow0 = 
						...
						fTableQAM64SM[BI_000 /* [0 0 0] */][0],
						fTableQAM64SM[BI_010 /* [0 1 0] */][0],
						fTableQAM64SM[BI_001 /* [0 0 1] */][0],
						fTableQAM64SM[BI_011 /* [0 1 1] */][0],
						(*pcInSymb)[i].rChan,
						vecSubsetDef2[k], vecSubsetDef3[k]);

					vecMetric[k].rTow1 = 
						Minimum4((*pcInSymb)[i].cSig.real(),
						fTableQAM64SM[BI_100 /* [1 0 0] */][0], 
						fTableQAM64SM[BI_110 /* [1 1 0] */][0], 
						fTableQAM64SM[BI_101 /* [1 0 1] */][0], 
						fTableQAM64SM[BI_111 /* [1 1 1] */][0],
						(*pcInSymb)[i].rChan,
						vecSubsetDef2[k], vecSubsetDef3[k]);
#else
					...
					vecMetric[k].rTow0 = 
						Minimum1((*pcInSymb)[i].cSig.real(), 
						fTableQAM64SM[iTabInd0][0],	(*pcInSymb)[i].rChan);

					vecMetric[k].rTow1 = 
						Minimum1((*pcInSymb)[i].cSig.real(),
						fTableQAM64SM[iTabInd0 | (1 << 2)][0],
						(*pcInSymb)[i].rChan);
#endif
					...
					vecMetric[k + 1].rTow0 = 
						...
						fTableQAM64SM[BI_000 /* [0 0 0] */][1],
						fTableQAM64SM[BI_010 /* [0 1 0] */][1],
						fTableQAM64SM[BI_001 /* [0 0 1] */][1],
						fTableQAM64SM[BI_011 /* [0 1 1] */][1],
						(*pcInSymb)[i].rChan,
						vecSubsetDef2[k + 1], vecSubsetDef3[k + 1]);

					vecMetric[k + 1].rTow1 = 
						Minimum4((*pcInSymb)[i].cSig.imag(),
						fTableQAM64SM[BI_100 /* [1 0 0] */][1],
						fTableQAM64SM[BI_110 /* [1 1 0] */][1],
						fTableQAM64SM[BI_101 /* [1 0 1] */][1],
						fTableQAM64SM[BI_111 /* [1 1 1] */][1],
						(*pcInSymb)[i].rChan,
						vecSubsetDef2[k + 1], vecSubsetDef3[k + 1]);
#else
					/* Lowest bit defined by "vecSubsetDef3" next bit defined
					...
					vecMetric[k + 1].rTow0 = 
						Minimum1((*pcInSymb)[i].cSig.imag(),
						fTableQAM64SM[iTabInd0][1],	(*pcInSymb)[i].rChan);

					vecMetric[k + 1].rTow1 = 
						Minimum1((*pcInSymb)[i].cSig.imag(),
						fTableQAM64SM[iTabInd0 | (1 << 2)][1],
						(*pcInSymb)[i].rChan);
#endif
				}
				else
		...
		case 1:
			for (i = 0, k = 0; i < iInputBlockSize; i++, k += 2)
			{
				if (bIteration == TRUE)
				{
					...
					vecMetric[k + 1].rTow0 =
						Minimum1((*pcInSymb)[i].cSig.imag(),
						fTableQAM64SM[iTabInd0][1],
						(*pcInSymb)[i].rChan);

					vecMetric[k + 1].rTow1 =
						Minimum1((*pcInSymb)[i].cSig.imag(),
						fTableQAM64SM[iTabInd0 | (1 << 1)][1],
						(*pcInSymb)[i].rChan);
#endif
				}
				else
				{
					...
					vecMetric[k].rTow0 =
						Minimum2((*pcInSymb)[i].cSig.real(),
						fTableQAM64SM[iTabInd0][0],
						fTableQAM64SM[iTabInd0 | 1][0], (*pcInSymb)[i].rChan);
					...
					vecMetric[k + 1].rTow0 =
						Minimum2((*pcInSymb)[i].cSig.imag(),
						fTableQAM64SM[iTabInd0][1],
						fTableQAM64SM[iTabInd0 | 1][1], (*pcInSymb)[i].rChan);
	...
	case CParameter::CS_3_HMSYM:
		...
		case 0:
			for (i = 0, k = 0; i < iInputBlockSize; i++, k += 2)
			{
				if (bIteration == TRUE)
				{
					...
					vecMetric[k].rTow0 = Minimum1((*pcInSymb)[i].cSig.real(), 
						fTableQAM64HMsym[iTabInd0][0], (*pcInSymb)[i].rChan);

					vecMetric[k].rTow1 = Minimum1((*pcInSymb)[i].cSig.real(),
						fTableQAM64HMsym[iTabInd0 | (1 << 2)][0],
						(*pcInSymb)[i].rChan);
					...
					vecMetric[k + 1].rTow0 =
						Minimum1((*pcInSymb)[i].cSig.imag(),
						fTableQAM64HMsym[iTabInd0][1], (*pcInSymb)[i].rChan);

					vecMetric[k + 1].rTow1 =
						Minimum1((*pcInSymb)[i].cSig.imag(),
						fTableQAM64HMsym[iTabInd0 | (1 << 2)][1],
						(*pcInSymb)[i].rChan);
				}
				else
				{
					...
					vecMetric[k].rTow0 =
						Minimum4((*pcInSymb)[i].cSig.real(), 
						fTableQAM64HMsym[BI_000 /* [0 0 0] */][0],
						fTableQAM64HMsym[BI_001 /* [0 0 1] */][0],
						fTableQAM64HMsym[BI_010 /* [0 1 0] */][0],
						fTableQAM64HMsym[BI_011 /* [0 1 1] */][0],
						(*pcInSymb)[i].rChan);

					vecMetric[k].rTow1 =
						Minimum4((*pcInSymb)[i].cSig.real(),
						fTableQAM64HMsym[BI_100 /* [1 0 0] */][0], 
						fTableQAM64HMsym[BI_101 /* [1 0 1] */][0], 
						fTableQAM64HMsym[BI_110 /* [1 1 0] */][0], 
						fTableQAM64HMsym[BI_111 /* [1 1 1] */][0],
						(*pcInSymb)[i].rChan);
					...
					vecMetric[k + 1].rTow0 =
						Minimum4((*pcInSymb)[i].cSig.imag(),
						fTableQAM64HMsym[BI_000 /* [0 0 0] */][1],
						fTableQAM64HMsym[BI_001 /* [0 0 1] */][1],
						fTableQAM64HMsym[BI_010 /* [0 1 0] */][1],
						fTableQAM64HMsym[BI_011 /* [0 1 1] */][1],
						(*pcInSymb)[i].rChan);

					vecMetric[k + 1].rTow1 =
						Minimum4((*pcInSymb)[i].cSig.imag(),
						fTableQAM64HMsym[BI_100 /* [1 0 0] */][1], 
						fTableQAM64HMsym[BI_101 /* [1 0 1] */][1], 
						fTableQAM64HMsym[BI_110 /* [1 1 0] */][1], 
						fTableQAM64HMsym[BI_111 /* [1 1 1] */][1],
						(*pcInSymb)[i].rChan);
				}
			}
		...
		case 1:
			for (i = 0, k = 0; i < iInputBlockSize; i++, k += 2)
			{
				if (bIteration == TRUE)
				{
					...
					vecMetric[k].rTow0 = Minimum1((*pcInSymb)[i].cSig.real(), 
						fTableQAM64HMsym[iTabInd0][0],
						(*pcInSymb)[i].rChan);

					vecMetric[k].rTow1 = Minimum1((*pcInSymb)[i].cSig.real(),
						fTableQAM64HMsym[iTabInd0 | (1 << 1)][0],
						(*pcInSymb)[i].rChan);
					...
					vecMetric[k + 1].rTow1 =
						Minimum1((*pcInSymb)[i].cSig.imag(),
						fTableQAM64HMsym[iTabInd0 | (1 << 1)][1],
						(*pcInSymb)[i].rChan);
				}
				else
				{
					...
					vecMetric[k + 1].rTow0 =
						Minimum2((*pcInSymb)[i].cSig.imag(), 
						fTableQAM64HMsym[iTabInd0][1],
						fTableQAM64HMsym[iTabInd0 | 1][1],
						(*pcInSymb)[i].rChan);
		...
		case 2:
			for (i = 0, k = 0; i < iInputBlockSize; i++, k += 2)
			{
				...
				vecMetric[k].rTow1 = Minimum1((*pcInSymb)[i].cSig.real(),
					fTableQAM64HMsym[iTabInd0 | 1][0], (*pcInSymb)[i].rChan);
				...
				vecMetric[k + 1].rTow1 = Minimum1((*pcInSymb)[i].cSig.imag(),
					fTableQAM64HMsym[iTabInd0 | 1][1], (*pcInSymb)[i].rChan);
			}
	...
	case CParameter::CS_3_HMMIX:
			...
			for (i = 0; i < iInputBlockSize; i++)
			{
				if (bIteration == TRUE)
				{
					...
					vecMetric[i].rTow0 = Minimum1((*pcInSymb)[i].cSig.real(), 
						fTableQAM64HMmix[iTabInd0][0], (*pcInSymb)[i].rChan);

					vecMetric[i].rTow1 = Minimum1((*pcInSymb)[i].cSig.real(),
						fTableQAM64HMmix[iTabInd0 | (1 << 2)][0],
						(*pcInSymb)[i].rChan);
				}
				else
				{
					...
					vecMetric[i].rTow0 = Minimum4((*pcInSymb)[i].cSig.real(), 
						fTableQAM64HMmix[BI_000 /* [0 0 0] */][0],
						fTableQAM64HMmix[BI_001 /* [0 0 1] */][0],
						fTableQAM64HMmix[BI_010 /* [0 1 0] */][0],
						fTableQAM64HMmix[BI_011 /* [0 1 1] */][0],
						(*pcInSymb)[i].rChan);

					vecMetric[i].rTow1 = Minimum4((*pcInSymb)[i].cSig.real(),
						fTableQAM64HMmix[BI_100 /* [1 0 0] */][0], 
						fTableQAM64HMmix[BI_101 /* [1 0 1] */][0], 
						fTableQAM64HMmix[BI_110 /* [1 1 0] */][0], 
						fTableQAM64HMmix[BI_111 /* [1 1 1] */][0],
						(*pcInSymb)[i].rChan);
				}
			}
			...
			for (i = 0; i < iInputBlockSize; i++)
			{
				if (bIteration == TRUE)
				{
					...
					vecMetric[i].rTow0 = Minimum1((*pcInSymb)[i].cSig.imag(),
						fTableQAM64HMmix[iTabInd0][1], (*pcInSymb)[i].rChan);

					vecMetric[i].rTow1 = Minimum1((*pcInSymb)[i].cSig.imag(),
						fTableQAM64HMmix[iTabInd0 | (1 << 2)][1],
						(*pcInSymb)[i].rChan);
				}
				else
				{
					...
					vecMetric[i].rTow0 = Minimum4((*pcInSymb)[i].cSig.imag(),
						fTableQAM64HMmix[BI_000 /* [0 0 0] */][1],
						fTableQAM64HMmix[BI_001 /* [0 0 1] */][1],
						fTableQAM64HMmix[BI_010 /* [0 1 0] */][1],
						fTableQAM64HMmix[BI_011 /* [0 1 1] */][1],
						(*pcInSymb)[i].rChan);

					vecMetric[i].rTow1 = Minimum4((*pcInSymb)[i].cSig.imag(),
						fTableQAM64HMmix[BI_100 /* [1 0 0] */][1], 
						fTableQAM64HMmix[BI_101 /* [1 0 1] */][1], 
						fTableQAM64HMmix[BI_110 /* [1 1 0] */][1], 
						fTableQAM64HMmix[BI_111 /* [1 1 1] */][1],
						(*pcInSymb)[i].rChan);
				}
			}
		...
		case 2:
			for (i = 0; i < iInputBlockSize; i++)
			{
				if (bIteration == TRUE)
				{
					...
					vecMetric[i].rTow1 = Minimum1((*pcInSymb)[i].cSig.real(),
						fTableQAM64HMmix[iTabInd0 | (1 << 1)][0],
						(*pcInSymb)[i].rChan);
				}
				else
				{
					...
					vecMetric[i].rTow0 = Minimum2((*pcInSymb)[i].cSig.real(), 
						fTableQAM64HMmix[iTabInd0][0],
						fTableQAM64HMmix[iTabInd0 | 1][0],
						(*pcInSymb)[i].rChan);
		...
		case 3:
			for (i = 0; i < iInputBlockSize; i++)
			{
				if (bIteration == TRUE)
				{
					...
					vecMetric[i].rTow1 = Minimum1((*pcInSymb)[i].cSig.imag(),
						fTableQAM64HMmix[iTabInd0 | (1 << 1)][1],
						(*pcInSymb)[i].rChan);
				}
				else
				{
					...
					vecMetric[i].rTow0 = Minimum2((*pcInSymb)[i].cSig.imag(), 
						fTableQAM64HMmix[iTabInd0][1],
						fTableQAM64HMmix[iTabInd0 | 1][1], (*pcInSymb)[i].rChan);
		...
		case 4:
			for (i = 0; i < iInputBlockSize; i++)
			{
				...
				vecMetric[i].rTow1 = Minimum1((*pcInSymb)[i].cSig.real(),
					fTableQAM64HMmix[iTabInd0 | 1][0], (*pcInSymb)[i].rChan);
			}
