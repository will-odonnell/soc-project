...
/* Classes ********************************************************************/
	inline _FREAL Metric(const _FREAL rDist, const _FREAL rChan)
	{
...
#endif
/* cj temp */
	inline _FREAL Minimum1(const _FREAL rA, const _FREAL rB,
	...
	inline _FREAL Minimum2(const _FREAL rA, const _FREAL rB1, const _FREAL rB2,
						  const _FREAL rChan) const
	{
		/* First, calculate all distances */
	...
	inline _FREAL Minimum4(const _FREAL rA, const _FREAL rB1, const _FREAL rB2,
